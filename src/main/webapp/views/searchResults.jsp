      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Poster</button>
									...
									<div class="product-feed-tab current" id="feed-dd">
                                     <%
                                     List<Utilisateur> friends = null ;
                                     String query = (String) request.getAttribute("query");
                                     if (query != null && !query.isEmpty()) {
                                 	    
                                  	   friends = us.searchFriends(query);

                                  	    request.setAttribute("user", friends);
                                      ...
                                      if (friends != null && !friends.isEmpty()) {
                                          for (Utilisateur friend : friends) {
                                        	  boolean estAmi = false;
                                        	    for (Amis ami : amis) {
                                        	        if (ami.getAmi().getIdu() == friend.getIdu()) {
                                        	            estAmi = true;
                                        	            break;
                                        	        }
                                        	    }
    ...
    <div class="posts-section">
        <div class="post-bar">
            <div class="post_topbar">
                <div class="usy-dt">
                    <img src="/ProjetJ2E/images/<%=friend.getProfilImg() %>" alt="" width="30px" height="30px">
                    <div class="row">
    <div class="col-md-8">
        <h3><%= friend.getPrenom() %> <%= friend.getNom() %></h3>
        <p><strong>Ville :</strong> <%= friend.getVille().getNom() %></p>
        
        
    </div>
    <div class="col-md-4">
        <div class="text-center">
            <form action="/ProjetJ2E/ConsulterAmisByProfile" method="get">
            <%System.out.println("ff" + friend.getIdu()); %>
                <input type ="hidden" name="ami" value="<%=friend.getIdu()%>">
        ...
        <div class="text-center">
            <% if (!estAmi) { %>
                <form action="/ProjetJ2E/Suivre" method="post">
                    <input type="hidden" name="ida" value="<%= friend.getIdu() %>">
